...
import { MaxLength, MinLength, GreaterThan, LessThan } from "./scalars.js";
export class maxLength extends SchemaDirectiveVisitor {
  ...
  wrapType(field) {
    if (field.type instanceof GraphQLNonNull && field.type.ofType instanceof GraphQLScalarType) {
      field.type = new GraphQLNonNull(new MaxLength(field.type.ofType, this.args.limit));
...
export class minLength extends SchemaDirectiveVisitor {
  ...
  wrapType(field) {
    if (field.type instanceof GraphQLNonNull && field.type.ofType instanceof GraphQLScalarType) {
      field.type = new GraphQLNonNull(new MinLength(field.type.ofType, this.args.limit));
    } else if (field.type instanceof GraphQLScalarType) {
...
export class greaterThan extends SchemaDirectiveVisitor {
  ...
  wrapType(field) {
    if (field.type instanceof GraphQLNonNull && field.type.ofType instanceof GraphQLScalarType) {
      field.type = new GraphQLNonNull(new GreaterThan(field.type.ofType, this.args.value));
    } else if (field.type instanceof GraphQLScalarType) {
...
export class lessThan extends SchemaDirectiveVisitor {
  ...
  wrapType(field) {
    if (field.type instanceof GraphQLNonNull && field.type.ofType instanceof GraphQLScalarType) {
      field.type = new GraphQLNonNull(new LessThan(field.type.ofType, this.args.value));
    } else if (field.type instanceof GraphQLScalarType) {
