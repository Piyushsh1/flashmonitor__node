...
<html lang="en">
<head>
    <title>Code coverage report for src/root-node.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> root-node.js
    </h1>
    <div class='clearfix'>
...
export default class RootNode extends Node {
  constructor(value, config) <span class="branch-1 cbranch-skip" title="branch not covered" >{</span>
    const parentNode = {
